...
class AppLocalizationsMy extends AppLocalizations {
  ...
  String locationCapturedAt(String time) {
    return 'တည်နေရာအချိန် - $time';
  }

  @override
  String lastKnownLocationAt(String time) {
    return 'နောက်ဆုံးသိရှိချိန် - $time';
  }
  ...
  String shelterDataTime(String time) {
    return 'အမိုးအကာအချက်အလက် - $time';
  }

  @override
  String hazardDataTime(String time) {
    return 'အန္တရာယ်အချက်အလက် - $time';
  }

  @override
  String navigationCachedAt(String time) {
    return 'အော့ဖ်လိုင်းအသုံးပြုရန် သိမ်းထားချိန် - $time';
  }
  ...
  @override
  String get retryNavigationData => 'အမိုးအကာနှင့် အန္တရာယ်အချက်အလက် ထပ်ယူရန်';
  ...
  @override
  String get shelterListHeading => 'ရရှိနိုင်သော မြေပုံပေါ်ရှိအမိုးအကာများ';
  ...
  @override
  String get activeShaking => 'လှုပ်ခတ်နေစဉ် - ချက်ချင်းလမ်းညွှန်မှု ပြရန်';

  @override
  String contextDistance(int distance) {
    return 'အကွာအဝေး - $distance မီတာ';
  }

  @override
  String contextElevation(String elevation) {
    return 'နှိုင်းယှဉ်မြေမျက်နှာပြင်အမြင့် - $elevation မီတာ';
  }

  @override
  String contextClearance(int building, int tree) {
    return 'အဆောက်အအုံရှင်းလင်းအကွာ - $building မီတာ၊ သစ်ပင်ရှင်းလင်းအကွာ - $tree မီတာ';
  }
  ...
  String contextBuildingDensity(String density) {
    return 'မြေပုံပေါ်ရှိ အဆောက်အအုံသိပ်သည်းမှု - $density%';
  }

  @override
  String contextTreeDensity(String density) {
    return 'မြေပုံပေါ်ရှိ သစ်ပင်သိပ်သည်းမှု - $density%';
  }

  @override
  String contextHazardIntersections(int count) {
    return 'မြေပုံပေါ်ရှိ အန္တရာယ်ဖြတ်တောက်မှု - $count';
  }
  ...
  String contextDataAt(String time) {
    return 'ခွဲခြမ်းစိတ်ဖြာအချက်အလက် - $time';
  }
  ...
  @override
  String get sosBluetoothReceiveTitle => 'အနီးအနား SOS သတိပေးချက်များ လက်ခံရန်';
  ...
  String sosBluetoothRelayCount(int count) {
    return 'ဤစက်ရှင်တွင် ပြန်လည်ထုတ်လွှင့်ထားသော frame - $count';
  }
  ...
  String sosBluetoothGridLocation(String latitude, String longitude) {
    return 'ကိုဩဒိနိတ် - $latitude, $longitude';
  }
  ...
  String sosBluetoothRssiValue(int value) {
    return 'အချက်ပြ - $value dBm၊ အနီးအဝေးမှာ ခန့်မှန်းခြေဖြစ်သည်';
  }

  @override
  String sosBluetoothProtocol(int version, int ttl) {
    return 'ပရိုတိုကော - v$version၊ TTL - $ttl မိနစ်';
  }

  @override
  String sosBluetoothRelayHops(int count) {
    return 'ပြန်လည်ထုတ်လွှင့်မှုအဆင့် - $count';
  }
  ...
  String sosBluetoothSourceLabel(int index) {
    return 'SOS ရင်းမြစ် $index';
  }

  @override
  String get sosBluetoothSelectedEventHeading => 'ရွေးထားသော SOS အသေးစိတ်';

  @override
  String sosBluetoothSelectEvent(int index) {
    return 'အနီးအနား SOS $index ကို ရွေးရန်';
  }
  ...
  @override
  String get retryRouteSuggestions => 'လမ်းကြောင်းအကြံပြုချက် ထပ်တောင်းရန်';
  ...
  String cachedRouteAt(String time) {
    return 'လမ်းကြောင်းသိမ်းထားချိန် - $time';
  }
  ...
  String routeAlternative(int number) {
    return 'အခြားရွေးချယ်စရာ $number';
  }
  ...
  String routeDurationValue(String duration) {
    return 'ကြာချိန် - $duration မိနစ်';
  }

  @override
  String routeHazardIntersections(int count) {
    return 'အန္တရာယ်ဖြတ်တောက်မှု - $count';
  }

  @override
  String routeRationale(String rationale) {
    return 'အကြောင်းပြချက် - $rationale';
  }

  @override
  String routeGeneratedAt(String time) {
    return 'ဖန်တီးချိန် - $time';
  }

  @override
  String routeHazardDataAt(String time) {
    return 'အန္တရာယ်အချက်အလက်အချိန် - $time';
  }

  @override
  String routeDirectionsProvider(String provider) {
    return 'လမ်းညွှန်ပေးသူ - $provider';
  }

  @override
  String routeProfileReason(String reason) {
    return 'ပုံစံရွေးချယ်ရသည့်အကြောင်း - $reason';
  }

  @override
  String uncertaintyNotice(String notice) {
    return 'မသေချာမှု - $notice';
  }

  @override
  String get mapSuggestedSelectedLabel => 'အကြံပြုထားသော ရွေးချယ်လမ်းကြောင်း';
  ...
  @override
  String get sosReadinessNeedsContact => 'အရေးပေါ်အဆက်အသွယ်ကို ဦးစွာရွေးပါ';
  ...
  @override
  String get sosManageContacts => 'နောက်ထပ်တွင် အဆက်အသွယ်များဖွင့်ရန်';
  ...
  @override
  String get sosProfileNameUnavailable => 'ပရိုဖိုင်အမည် - မပါဝင်ပါ';
  ...
  String sosCurrentLocationPreview(
    ...
    return 'လက်ရှိ $precision တည်နေရာ - $latitude, $longitude။ ဖမ်းယူချိန် $time။';
  }
  ...
  String sosLastKnownLocationPreview(
    ...
    return 'နောက်ဆုံးသိရှိထားသော $precision တည်နေရာ - $latitude, $longitude။ ဖမ်းယူချိန် $time။';
  }

  @override
  String get sosLocationUnavailable => 'တည်နေရာမရနိုင်ပါ။ ကိုဩဒိနိတ်မပါဝင်ပါ။';
  ...
  @override
  String get sosOptionalMessageLabel => 'ရွေးချယ်နိုင်သော တိုတောင်းသည့်စာ';
  ...
  @override
  String get sosLocationSharingTitle => 'ဤ SOS တွင် တည်နေရာထည့်ရန်';
  ...
  @override
  String get sosLocationSharingUnavailableTitle => 'တည်နေရာမရနိုင်ပါ';
  ...
  @override
  String get sosContinueWithoutLocation => 'တည်နေရာမပါဘဲ ဆက်လုပ်ရန်';
  ...
  @override
  String get sosConfirmPreviewTitle => 'SOS draft အသေးစိတ်ကို အတည်ပြုရန်';
  ...
  @override
  String get sosConfirmComposerTitle => 'စာပို့အက်ပ်ကို ဖွင့်မလား။';
  ...
  @override
  String get sosRetrySmsTitle => 'ဤ SOS draft ကို ထပ်ပေးပို့မလား။';
  ...
  @override
  String get sosRememberSim => 'ကျွန်ုပ်နှစ်သက်သော SIM ကို မှတ်ထားရန်';
  ...
  @override
  String get sosDraftQueueEmpty => 'ဤစက်တွင် SOS draft မပြင်ဆင်ရသေးပါ။';
  ...
  @override
  String get sosStatusSmsSent => 'စက်က SMS လက်ခံပြီး၊ ရောက်ရှိမှုမသေချာ';
  ...
  @override
  String get sosStatusSmsFailed => 'SMS မအောင်မြင်၊ ထပ်ကြိုးစားနိုင်သည်';

  @override
  String get sosStatusComposerOpened => 'စာပို့အက်ပ်ဖွင့်ပြီး၊ ရလဒ်မသိရသေး';
  ...
  @override
  String get sosRetryComposerTitle => 'ဤ draft ကို ထပ်ဖွင့်မလား။';
  ...
  @override
  String get sosCancelDraftTitle => 'ဤ draft ကို ပယ်ဖျက်မလား။';
  ...
  @override
  String get sosRemoveDraftTitle => 'ဤ draft ကို ဖယ်ရှားမလား။';
  ...
  @override
  String get sosQueueLoading => 'လုံခြုံသော SOS draft များကို ဖွင့်နေသည်';

  @override
  String get sosQueueReadErrorTitle => 'SOS draft များ ယာယီမရနိုင်ပါ';
  ...
  @override
  String get sosResetQueueTitle => 'ဖတ်မရသော SOS queue ကို reset လုပ်မလား။';
  ...
  String sosMessageCurrentLocation(
    ...
    return 'လက်ရှိ $precision တည်နေရာ - $latitude, $longitude၊ $time။ မြေပုံ - $mapsLink';
  }
  ...
  String sosMessageLastKnownLocation(
    ...
    return 'နောက်ဆုံးသိရှိထားသော $precision တည်နေရာ - $latitude, $longitude၊ $time။ မြေပုံ - $mapsLink';
  }
  ...
  @override
  String get guideSearchHint => 'ငလျင်၊ ပိတ်မိ၊ ရေကြီးမှု၊ မီး၊ ရှေးဦးသူနာပြု';
  ...
  @override
  String get guideStorageError => 'ဤစက်မှ အော့ဖ်လိုင်းလမ်းညွှန်ကို ဖတ်မရပါ။';
  ...
  @override
  String get guideOpenArticleHint => 'အတည်ပြုထားသော အရေးပေါ်ဆောင်းပါးဖွင့်ရန်';
  ...
  String guideContentVersion(int version) {
    return 'အကြောင်းအရာဗားရှင်း - $version';
  }
  ...
  String guideSourceDate(String date) {
    return 'ရင်းမြစ်အပ်ဒိတ်ရက် - $date';
  }
  ...
  String guideSourceSemantics(String source, int version) {
    return 'အတည်ပြုရင်းမြစ် $source၊ အကြောင်းအရာဗားရှင်း $version';
  }
  ...
  @override
  String get assistantSuggestionEarthquake => 'ငလျင်လှုပ်နေစဉ် ဘာလုပ်ရမလဲ။';

  @override
  String get assistantSuggestionTrapped => 'ငလျင်ပြီးနောက် ပိတ်မိနေသည်';
  ...
  @override
  String get assistantSuggestionFlood => 'ရေကြီးမှုကို ဘယ်လိုရှောင်ရမလဲ။';
  ...
  @override
  String get assistantInputHint => 'အင်္ဂလိပ် သို့မဟုတ် မြန်မာလို ရိုက်ပါ';
  ...
  @override
  String get assistantReviewSos => 'အသုံးပြုသူစစ်ဆေးရန် SOS ဖွင့်ပါ';
  ...
  @override
  String get languageReadErrorTitle => 'ဘာသာစကားရွေးချယ်မှု ယာယီမရနိုင်ပါ';
  ...
  @override
  String get languageWriteErrorTitle => 'ဘာသာစကားရွေးချယ်မှုကို မသိမ်းနိုင်ပါ';
  ...
  String contactsSummary(int count, int selected) {
    return 'အဆက်အသွယ် $count ခု၊ SOS အတွက်ရွေးထားသည် $selected ခု';
  }
  ...
  @override
  String get profileDataErrorTitle => 'သိမ်းထားသောပရိုဖိုင်ကို ဖွင့်မရပါ';
  ...
  @override
  String get resetLocalProfileTitle => 'ဖတ်မရသောပရိုဖိုင်ကို reset လုပ်မလား။';
  ...
  @override
  String get contactsEmptyTitle => 'အရေးပေါ်အဆက်အသွယ် မရှိသေးပါ';
  ...
  String maximumContactsReached(int count) {
    return 'အရေးပေါ်အဆက်အသွယ် အများဆုံး $count ခု သိမ်းနိုင်သည်။';
  }
  ...
  @override
  String get addContactTitle => 'အရေးပေါ်အဆက်အသွယ် ထည့်ရန်';

  @override
  String get editContactTitle => 'အရေးပေါ်အဆက်အသွယ် ပြင်ရန်';
  ...
  @override
  String get relationshipRequired => 'ဆက်ဆံရေး သို့မဟုတ် အညွှန်း ထည့်ပါ။';
  ...
  @override
  String get contactNotFound => 'ဤအရေးပေါ်အဆက်အသွယ်ကို မတွေ့ပါ။';

  @override
  String get backToContacts => 'အရေးပေါ်အဆက်အသွယ်များသို့ ပြန်ရန်';
  ...
  String lastSuccessfulUpdate(String time) {
    return 'နောက်ဆုံးအောင်မြင်သောအပ်ဒိတ် - $time';
  }
  ...
  String magnitudeValue(String magnitude) {
    return 'ပြင်းအား $magnitude';
  }

  @override
  String locationValue(String place) {
    return 'တည်နေရာ - $place';
  }

  @override
  String eventTimeValue(String time) {
    return 'ဖြစ်ရပ်အချိန် - $time';
  }
  ...
  String depthValue(String depth) {
    return 'အနက် - $depth ကီလိုမီတာ';
  }

  @override
  String providerUpdateValue(String time) {
    return 'ဝန်ဆောင်မှုပေးသူအပ်ဒိတ် - $time';
  }

  @override
  String retrievedValue(String time) {
    return 'ရယူချိန် - $time';
  }

  @override
  String reviewStatusValue(String status) {
    return 'စစ်ဆေးမှုအခြေအနေ - $status';
  }
  ...
  @override
  String get couldNotOpenUsGSsource => 'USGS ရင်းမြစ်ကို ဖွင့်မရပါ။';

  @override
  String get earthquakeInformationNotFound => 'ငလျင်အချက်အလက်ကို မတွေ့ပါ။';

  @override
  String get backToEarthquakeInformation => 'ငလျင်အချက်အလက်သို့ ပြန်ရန်';
  ...
  @override
  String get earthquakeCardHint => 'ငလျင်အချက်အလက်အသေးစိတ်ဖွင့်ရန်';

  @override
  String get preliminaryNotice => 'ကနဦးငလျင်တန်ဖိုးများ ပြောင်းလဲနိုင်သည်။';

  @override
  String get loadingEarthquakes => 'ငလျင်အချက်အလက်ကို အပ်ဒိတ်လုပ်နေသည်';
}
